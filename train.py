...
parser.add_argument("--dataset_dir", default="./data", required=True, type=str, help="Local dataset directory should include train.txt, dev.txt and label.txt")
...
parser.add_argument('--model_name', default="roberta-base", help="Select model to train, defaults to roberta-base.",
                    choices=["roberta-base","bert-base-chinese","ernie-1.0-large-zh-cw","ernie-3.0-xbase-zh", "ernie-3.0-base-zh", "ernie-3.0-medium-zh", "ernie-3.0-micro-zh", "ernie-3.0-mini-zh", "ernie-3.0-nano-zh", "ernie-2.0-base-en", "ernie-2.0-large-en","ernie-m-base","ernie-m-large"])
